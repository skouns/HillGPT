    ...
    <div className="min-h-screen bg-[#fdfdf9] text-gray-900 flex items-center justify-center px-4 py-6">
      <div className="w-full max-w-4xl h-[90vh] flex flex-col rounded-xl border border-blue-700 bg-blue-900 backdrop-blur-xl shadow-2xl overflow-hidden">
        ...
        <form
          ...
          autoComplete="off"
          className="flex items-center gap-3 px-6 py-4 border-t border-blue-700 bg:white/10 bg-white/10"
        >
          <textarea
            value={input}
            onChange={(e) => setInput(e.target.value)}
            placeholder="Type a message... (Shift+Enter for newline)"
            className="flex-1 rounded-lg px-4 py-2 text-sm text:white text-white bg-blue-800 placeholder-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-400 border border-blue-600 resize-none overflow-y-hidden"
            ref={inputRef}
